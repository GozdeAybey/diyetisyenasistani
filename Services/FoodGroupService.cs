...
public class FoodGroupService
{
        ...
        int oilySeed)
    {
        ...
        int carbs =
            ...
            oilySeed * groups.First(x => x.Name == "Yağlı Tohum").CarbsPerExchange;   // ✅ EKLENDİ
        ...
        int protein =
            ...
            oilySeed * groups.First(x => x.Name == "Yağlı Tohum").ProteinPerExchange; // ✅ EKLENDİ
        ...
        int fatTotal =
            ...
            oilySeed * groups.First(x => x.Name == "Yağlı Tohum").FatPerExchange;     // ✅ EKLENDİ
